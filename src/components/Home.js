        ...
        <div className="overlay p-10">
          <article className="text-center md:text-left">
            ...
            <p className="text-gray-400 md:w-11/12 lg:w-1/2">
              ...
              of this world experience! Space tourism is another niche segment of the aviation industry that seeks to give tourists the ability to become astronauts and experience space travel for recreational, leisure, or business purposes. 
            </p>
          </article>
          <article>
